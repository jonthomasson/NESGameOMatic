...
public class Data
{
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x9DA7 , 1   , 0x4000 ) ;}
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1F1CB, 1   , 0x440  ) ;}
  public OffsetRec getScreensOffset()   { return new OffsetRec(0x9CE7 , 4   , 48 ) ;}
  public int getBigBlocksCount()        { return 15; }
  ...
  {
    new LevelRec(0x14728, 4, 4, 1, 0x0),
  };
