...
{ 
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x7BEF , 1   , 0x4000 ) ;}
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1F1CB, 1   , 0x440  ) ;}
  public OffsetRec getScreensOffset()   { return new OffsetRec(0x7BAF , 1   , 48 ) ;}
  public int getBigBlocksCount()        { return 13; }
  ...
  {
    new LevelRec(0x1452F, 1, 1, 1, 0x0),
  };
