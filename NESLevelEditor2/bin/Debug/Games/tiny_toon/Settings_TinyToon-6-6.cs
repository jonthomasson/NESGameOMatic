...
public class Data
{
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x9E32 , 1   , 0x4000 ) ;}
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1F1CB, 1   , 0x440  ) ;}
  public OffsetRec getScreensOffset()   { return new OffsetRec(0x9Df2 , 1   , 48     ) ;}
  ...
  {
    new LevelRec(0x14643, 1, 1, 1, 0x0), //wrong ptr?
  };
  ...
  {
    return Utils.readVideoBankFromFile("videoBack_TT_64.bin", videoPageId);
  }
  
  public byte[] getPalleteLevel_3_3(int palId)
  {
    var pallete = new byte[] { 
      0x0F, 0x26, 0x20, 0x16, 0x0F, 0x10, 0x20, 0x00,
      0x0F, 0x24, 0x10, 0x11, 0x0F, 0x0f, 0x20, 0x38
    }; 
    return pallete;
  }
