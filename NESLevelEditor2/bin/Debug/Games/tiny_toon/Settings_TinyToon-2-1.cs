...
{ 
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x5592 , 1   , 0x4000 ) ;}
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1F1CB, 1   , 0x440  ) ;}
  public OffsetRec getScreensOffset()   { return new OffsetRec(0x52F2 , 14   , 48     ) ;}
  ...
  {
    new LevelRec(0x143D3, 16, 14, 1, 0x0),
  };
  ...
  public byte[] getPalleteLevel_2_1(int palId)
  {
    var pallete = new byte[] { 
      0x20, 0x0F, 0x26, 0x0A, 0x20, 0x0f, 0x38, 0x28,
      0x20, 0x0f, 0x31, 0x12, 0x20, 0x0f, 0x20, 0x38
    }; 
    return pallete;
  }
