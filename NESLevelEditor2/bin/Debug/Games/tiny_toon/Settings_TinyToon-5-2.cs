...
{ 
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x93C3 , 1   , 0x4000 ) ;}
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1F1CB, 1   , 0x440  ) ;}
  public OffsetRec getScreensOffset()   { return new OffsetRec(0x9213 , 10  , 48 ) ;}
  ...
  {
    new LevelRec(0x146B8, 11, 10, 1, 0x0),
  };
  ...
  public byte[] getPalleteLevel_5_1(int palId)
  {
    var pallete = new byte[] { 
      0x3A, 0x0F, 0x37, 0x27, 0x3A, 0x0f, 0x37, 0x15,
      0x3A, 0x0F, 0x20, 0x14, 0x3A, 0x0f, 0x20, 0x38
    }; 
    return pallete;
  }
