...
{ 
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x7E60 , 1   , 0x4000 ) ;}
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1F1CB, 1   , 0x440  ) ;}
  public OffsetRec getScreensOffset()   { return new OffsetRec(0x7C30 , 5   , 112 ) ;}
  ...
  {
    new LevelRec(0x14506, 12, 5, 1, 0x0),
  };
